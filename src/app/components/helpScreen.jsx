...
const HelpScreen = ({ open, handleClose }) => {
  const {
    site: {
      ...
      <DialogContent>
        <DialogContentText component="div" color="textPrimary">
          ...
          <Typography variant="body2" paragraph>
            ...
            op deze knop te klikken wordt uw setpoint berekend en worden de resulten getoont. Als het op basis van uw gegevens niet mogelijk is om een
            setpoint berekening te doen dan zal de app u dat vertellen.
          </Typography>
          <Typography variant="body2" paragraph>
